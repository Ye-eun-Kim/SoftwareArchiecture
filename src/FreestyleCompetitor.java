...
public class FreestyleCompetitor {
    private int id;
    private int age;
    private Name name;
    ...
    public FreestyleCompetitor(int id, int age, Name name, String email, int[] scoreArray) {
        this.id = id;
        this.age = age;
        this.name = name;
        this.email = email;
    ...
    public String getFullDetails(){
        return "Competitor number: "+id+", Name: "+getFullName()+", Age: "+age+", Category: freestyle"
